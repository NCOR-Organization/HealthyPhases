# onto2py-source-sha256: 9c1cd902297e0cb746e4c0b47b5377c4f3c6b859037cd140c0a2fc76a64d071e
...
class PDFPaperFile(GenericallyDependentContinuant, RDFEntity):
    """
    ...
    has_chunks: Optional[Annotated[List[Union[Chunk, URIRef, str]], Field()]] = None
...
class Chunk(GenericallyDependentContinuant, RDFEntity):
    ...
    chunk_number: Optional[Annotated[int, Field()]] = None
...
class LexicalOccurrence(GenericallyDependentContinuant, RDFEntity):
    """
...
class EmbeddingOccurrence(GenericallyDependentContinuant, RDFEntity):
    """
...
class Extraction(GenericallyDependentContinuant, RDFEntity):
    """
...
class ExtractedItem(GenericallyDependentContinuant, RDFEntity):
    """
    ...
    item_number: Optional[Annotated[int, Field()]] = None
    label: Optional[Annotated[str, Field(description="Label of the resource.")]] = None
    created: Optional[
        Annotated[
            datetime.datetime,
