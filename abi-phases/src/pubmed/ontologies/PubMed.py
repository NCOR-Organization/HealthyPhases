...
class PubMedPaperSummary(RDFEntity):
    ...
    _property_uris: ClassVar[dict] = {
        "aboutJournal": "https://w3id.org/pubmed/aboutJournal",
        "aboutJournalIssue": "https://w3id.org/pubmed/aboutJournalIssue",
        "authorLiteral": "https://w3id.org/pubmed/authorLiteral",
        "doi": "https://w3id.org/pubmed/doi",
        "downloadUrl": "https://w3id.org/pubmed/downloadUrl",
        "hasAuthorshipRole": "https://w3id.org/pubmed/hasAuthorshipRole",
        "journalTitleLiteral": "https://w3id.org/pubmed/journalTitleLiteral",
        "pages": "https://w3id.org/pubmed/pages",
        "pmcid": "https://w3id.org/pubmed/pmcid",
        "publicationDate": "https://w3id.org/pubmed/publicationDate",
        "pubmedIdentifier": "https://w3id.org/pubmed/pubmedIdentifier",
        "sortPublicationDate": "https://w3id.org/pubmed/sortPublicationDate",
        "summarizes": "https://w3id.org/pubmed/summarizes",
        "title": "https://w3id.org/pubmed/title",
        "url": "https://w3id.org/pubmed/url",
    }
...
class PubMedPaper(RDFEntity):
    ...
    _property_uris: ClassVar[dict] = {
        "hasAbstract": "https://w3id.org/pubmed/hasAbstract",
        "hasKeyword": "https://w3id.org/pubmed/hasKeyword",
        "hasMeshDescriptor": "https://w3id.org/pubmed/hasMeshDescriptor",
        "publishedIn": "https://w3id.org/pubmed/publishedIn",
    }
...
class LiteralContent(RDFEntity):
    ...
    _property_uris: ClassVar[dict] = {
        "literalValue": "https://w3id.org/pubmed/literalValue"
    }
...
class JournalIssue(RDFEntity):
    ...
    _property_uris: ClassVar[dict] = {
        "issueLabel": "https://w3id.org/pubmed/issueLabel",
        "issueOf": "https://w3id.org/pubmed/issueOf",
        "volume": "https://w3id.org/pubmed/volume",
    }
...
class AuthorshipRole(RDFEntity):
    ...
    _property_uris: ClassVar[dict] = {
        "roleHeldBy": "https://w3id.org/pubmed/roleHeldBy"
    }
