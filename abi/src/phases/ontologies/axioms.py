...
class ExtractedAxiom(RDFEntity):
    ...
    _class_uri: ClassVar[str] = (
        "http://purl.obolibrary.org/obo/phases/axioms.owl#ExtractedAxiom"
    )
    _name: ClassVar[str] = "extracted axiom"
    _property_uris: ClassVar[dict] = {
        "axiom_from_chunk": "http://purl.obolibrary.org/obo/phases/axioms.owl#axiom_from_chunk",
        "axiom_hash": "http://purl.obolibrary.org/obo/phases/axioms.owl#axiom_hash",
        "axiom_id": "http://purl.obolibrary.org/obo/phases/axioms.owl#axiom_id",
        "axiom_number": "http://purl.obolibrary.org/obo/phases/axioms.owl#axiom_number",
        "axiom_text": "http://purl.obolibrary.org/obo/phases/axioms.owl#axiom_text",
        "created": "http://purl.org/dc/terms/created",
        "creation_time": "http://purl.obolibrary.org/obo/phases/axioms.owl#creation_time",
        "creator": "http://purl.org/dc/terms/creator",
        "generated_by_model": "http://purl.obolibrary.org/obo/phases/axioms.owl#generated_by_model",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "prompt_version": "http://purl.obolibrary.org/obo/phases/axioms.owl#prompt_version",
...
ExtractedAxiom.model_rebuild(_types_namespace={"Chunk": Chunk})
