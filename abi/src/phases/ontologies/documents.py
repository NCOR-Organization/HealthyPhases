...
class PDFPaperFile(RDFEntity):
    ...
    _property_uris: ClassVar[dict] = {'created': 'http://purl.org/dc/terms/created', 'creation_time': 'http://purl.obolibrary.org/obo/phases/documents.owl#creation_time', 'creator': 'http://purl.org/dc/terms/creator', 'has_chunks': 'http://purl.obolibrary.org/obo/phases/documents.owl#has_chunks', 'label': 'http://www.w3.org/2000/01/rdf-schema#label', 'path': 'http://purl.obolibrary.org/obo/phases/documents.owl#path', 'pdf_hash': 'http://purl.obolibrary.org/obo/phases/documents.owl#pdf_hash', 'pdfpaperfile_id': 'http://purl.obolibrary.org/obo/phases/documents.owl#pdfpaperfile_id'}
    ...
    # Object properties
    has_chunks: Optional[Annotated[List[Union[Chunk, URIRef, str]], Field()]] = ['http://ontology.naas.ai/abi/unknown']
...
class Chunk(RDFEntity):
    ...
    _property_uris: ClassVar[dict] = {'chunk_hash': 'http://purl.obolibrary.org/obo/phases/documents.owl#chunk_hash', 'chunk_id': 'http://purl.obolibrary.org/obo/phases/documents.owl#chunk_id', 'chunk_number': 'http://purl.obolibrary.org/obo/phases/documents.owl#chunk_number', 'chunk_of': 'http://purl.obolibrary.org/obo/phases/documents.owl#chunk_of', 'created': 'http://purl.org/dc/terms/created', 'creator': 'http://purl.org/dc/terms/creator', 'has_embedding_occurrence': 'http://purl.obolibrary.org/obo/phases/documents.owl#has_embedding_occurrence', 'has_lexical_occurrence': 'http://purl.obolibrary.org/obo/phases/documents.owl#has_lexical_occurrence', 'label': 'http://www.w3.org/2000/01/rdf-schema#label', 'text': 'http://purl.obolibrary.org/obo/phases/documents.owl#text'}
    ...
    has_embedding_occurrence: Optional[Annotated[List[Union[EmbeddingOccurrence, URIRef, str]], Field()]] = ['http://ontology.naas.ai/abi/unknown']
    has_lexical_occurrence: Optional[Annotated[List[Union[LexicalOccurrence, URIRef, str]], Field()]] = ['http://ontology.naas.ai/abi/unknown']
...
class LexicalOccurrence(RDFEntity):
    ...
    _property_uris: ClassVar[dict] = {'created': 'http://purl.org/dc/terms/created', 'creator': 'http://purl.org/dc/terms/creator', 'label': 'http://www.w3.org/2000/01/rdf-schema#label', 'lexical_occurrence_in_chunk': 'http://purl.obolibrary.org/obo/phases/documents.owl#lexical_occurrence_in_chunk', 'lexical_occurrence_of': 'http://purl.obolibrary.org/obo/phases/documents.owl#lexical_occurrence_of', 'matched_predicate': 'http://purl.obolibrary.org/obo/phases/documents.owl#matched_predicate', 'matched_text': 'http://purl.obolibrary.org/obo/phases/documents.owl#matched_text'}
    ...
    lexical_occurrence_of: Annotated[Union[Class, URIRef, str], Field()]
...
class EmbeddingOccurrence(RDFEntity):
    ...
    _property_uris: ClassVar[dict] = {'created': 'http://purl.org/dc/terms/created', 'creator': 'http://purl.org/dc/terms/creator', 'embedding_occurrence_in_chunk': 'http://purl.obolibrary.org/obo/phases/documents.owl#embedding_occurrence_in_chunk', 'embedding_occurrence_of': 'http://purl.obolibrary.org/obo/phases/documents.owl#embedding_occurrence_of', 'label': 'http://www.w3.org/2000/01/rdf-schema#label', 'matched_predicate': 'http://purl.obolibrary.org/obo/phases/documents.owl#matched_predicate', 'matched_text': 'http://purl.obolibrary.org/obo/phases/documents.owl#matched_text'}
    ...
    embedding_occurrence_of: Annotated[Union[Class, URIRef, str], Field()]
