...
class ExtractedLabel(RDFEntity):
    ...
    _class_uri: ClassVar[str] = (
        "http://purl.obolibrary.org/obo/phases/labels.owl#ExtractedLabel"
    )
    _name: ClassVar[str] = "extracted label"
    _property_uris: ClassVar[dict] = {
        "created": "http://purl.org/dc/terms/created",
        "creation_time": "http://purl.obolibrary.org/obo/phases/labels.owl#creation_time",
        "creator": "http://purl.org/dc/terms/creator",
        "generated_by_model": "http://purl.obolibrary.org/obo/phases/labels.owl#generated_by_model",
        "label": "http://www.w3.org/2000/01/rdf-schema#label",
        "label_from_chunk": "http://purl.obolibrary.org/obo/phases/labels.owl#label_from_chunk",
        "label_hash": "http://purl.obolibrary.org/obo/phases/labels.owl#label_hash",
        "label_id": "http://purl.obolibrary.org/obo/phases/labels.owl#label_id",
        "label_number": "http://purl.obolibrary.org/obo/phases/labels.owl#label_number",
        "label_text": "http://purl.obolibrary.org/obo/phases/labels.owl#label_text",
        "prompt_version": "http://purl.obolibrary.org/obo/phases/labels.owl#prompt_version",
        "source_chunk_id": "http://purl.obolibrary.org/obo/phases/labels.owl#source_chunk_id",
    }
...
# Import Chunk from documents to resolve forward reference
from phases.ontologies.documents import Chunk

ExtractedLabel.model_rebuild(_types_namespace={"Chunk": Chunk})
