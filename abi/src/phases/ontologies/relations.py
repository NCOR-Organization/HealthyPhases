...
class InferredLabelRelation(RDFEntity):
    ...
    _class_uri: ClassVar[str] = 'http://purl.obolibrary.org/obo/phases/relations.owl#InferredLabelRelation'
    _name: ClassVar[str] = 'inferred label relation'
    _property_uris: ClassVar[dict] = {'belongs_confidence': 'http://purl.obolibrary.org/obo/phases/relations.owl#belongs_confidence', 'best_alternative_support': 'http://purl.obolibrary.org/obo/phases/relations.owl#best_alternative_support', 'best_alternative_target': 'http://purl.obolibrary.org/obo/phases/relations.owl#best_alternative_target', 'cooccurrence_count': 'http://purl.obolibrary.org/obo/phases/relations.owl#co_occurrence_count', 'cooccurrence_score': 'http://purl.obolibrary.org/obo/phases/relations.owl#co_occurrence_score', 'created': 'http://purl.org/dc/terms/created', 'creation_time': 'http://purl.obolibrary.org/obo/phases/relations.owl#creation_time', 'creator': 'http://purl.org/dc/terms/creator', 'directional_score': 'http://purl.obolibrary.org/obo/phases/relations.owl#directional_score', 'evidence_paths_count': 'http://purl.obolibrary.org/obo/phases/relations.owl#evidence_paths_count', 'exclusive_to_target_confidence': 'http://purl.obolibrary.org/obo/phases/relations.owl#exclusive_to_target_confidence', 'forward_axiom_votes': 'http://purl.obolibrary.org/obo/phases/relations.owl#forward_axiom_votes', 'label': 'http://www.w3.org/2000/01/rdf-schema#label', 'relation_from_label': 'http://purl.obolibrary.org/obo/phases/relations.owl#relation_from_label', 'relation_id': 'http://purl.obolibrary.org/obo/phases/relations.owl#relation_id', 'relation_to_label': 'http://purl.obolibrary.org/obo/phases/relations.owl#relation_to_label', 'relation_type': 'http://purl.obolibrary.org/obo/phases/relations.owl#relation_type', 'reverse_axiom_votes': 'http://purl.obolibrary.org/obo/phases/relations.owl#reverse_axiom_votes', 'source_label_text': 'http://purl.obolibrary.org/obo/phases/relations.owl#source_label_text', 'stability_score': 'http://purl.obolibrary.org/obo/phases/relations.owl#stability_score', 'supported_by_axiom': 'http://purl.obolibrary.org/obo/phases/relations.owl#supported_by_axiom', 'supported_by_chunk': 'http://purl.obolibrary.org/obo/phases/relations.owl#supported_by_chunk', 'target_label_text': 'http://purl.obolibrary.org/obo/phases/relations.owl#target_label_text'}
    _object_properties: ClassVar[set[str]] = {'relation_from_label', 'relation_to_label', 'supported_by_axiom', 'supported_by_chunk'}
    ...
    # Object properties
    relation_from_label: Optional[Annotated[List[Union[ExtractedLabel, URIRef, str]], Field()]] = ['http://ontology.naas.ai/abi/unknown']
    relation_to_label: Optional[Annotated[List[Union[ExtractedLabel, URIRef, str]], Field()]] = ['http://ontology.naas.ai/abi/unknown']
    supported_by_axiom: Optional[Annotated[List[Union[ExtractedAxiom, URIRef, str]], Field()]] = ['http://ontology.naas.ai/abi/unknown']
    supported_by_chunk: Optional[Annotated[List[Union[Chunk, URIRef, str]], Field()]] = ['http://ontology.naas.ai/abi/unknown']
